...
<p align="center">
  <img src="https://github.com/hientrinh93/SELEX/blob/master/MMworkflow.png" width="300" height="600" />
</p>

NGS-SELEX pipeline is built in a [Docker](https://www.docker.com) version 19.03.12 or a [Singularity](https://singularity.lbl.gov/) container that runs [Jupyter](https://jupyter.org) notebooks. It has been tested using a MacOS or Vagrant supporting a Ubuntu virtual machine.
